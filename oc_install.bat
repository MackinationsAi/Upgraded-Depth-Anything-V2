...
curl -L -o triton-2.1.0-cp310-cp310-win_amd64.whl https://huggingface.co/MackinationsAi/site-packages/resolve/main/triton/triton-2.1.0-cp310-cp310-win_amd64.whl?download=true
